...
<footer id="footer">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <img class="footer-logo" src="imgs/logo.png">
      ...
      <div class="col-md-4">
        <ul class="footer-list">
          <a href="{{url('blood-bank/home')}}"><li> الرئيسيه</li></a>
            <a href="{{url('blood-bank/contact')}}"><li> عن بنك الدم </li></a>
            <a href="{{url('blood-bank/posts')}}"> <li> المقالات </li></a>
            <a href="{{url('blood-bank/donation')}}"><li> طلبات التبرع </li></a>
            <a href="{{url('blood-bank/how-we-are')}}"> <li> من نحن </li></a>
            <a href="{{url('blood-bank/contact')}}">  <li> اتصل بنا </li></a>

        </ul>
        </div>
        <div class="col-md-4 change-position">
        <p class="footer-subtext">مـتــوفر علي </p>
        <img class="footer-android" src="{{asset('blood-bank/imgs/google1.png')}}">
        <img class="footer-ios" src="{{asset('blood-bank/imgs/ios1.png')}}">
...
{{-- <section class="overlay">
  <div class="spinner">
    ...
    <script src="{{asset('blood-bank/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('blood-bank/js/main.js')}}"></script>

    @stack('scripts') {{-- favourities | register->governorates --}}
  </div>
  </body>
</html>
